 ...
 *
 */
public class TraceConversionBlocking {
	/**
	 * Converts traces from Monitoring Log in specified folder
	 * 
	 * @param traceQueue
	 *            a queue into which the traces are stored
	 * @param traceFolders
	 *            folder with Monitoring Log
	 * @throws AnalysisConfigurationException
	 *             if there was an error when configuring filters
	 */
	public static void runAnalysis(BlockingQueue<Trace> traceQueue, String[] traceFolders)
			throws AnalysisConfigurationException {
		...
		final OPENxtraceBlockingFilter filter = new OPENxtraceBlockingFilter(new Configuration(), analysisController);
		filter.setTraceQueue(traceQueue);
